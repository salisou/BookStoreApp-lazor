...
BEGIN TRANSACTION
GO
PRINT N'Creazione di Chiave esterna [dbo].[FK_Books_ToTable]...';


GO
ALTER TABLE [dbo].[Books] WITH NOCHECK
    ADD CONSTRAINT [FK_Books_ToTable] FOREIGN KEY ([AuthorId]) REFERENCES [dbo].[Authors] ([Id]);
...
GO
ALTER TABLE [dbo].[Books] WITH CHECK CHECK CONSTRAINT [FK_Books_ToTable];
